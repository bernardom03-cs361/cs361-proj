        ...
        case 'about':
            return (
                <>
                    ...
                    <p>In addition, for those wondering about the usage of AI, queries are only generated once for each round daily. SITE WIDE. The edited response are then cached into a database system where the rest of the game information is stored, minimizing the cose of the generally expensive energy usage of AI in this app</p>
                </>
            );
        default:
            return null;
